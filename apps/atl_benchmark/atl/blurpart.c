...
void blurpart(float* v,int m,int n,float*output){
	...
	for (int H34 = 1; H34 < (n - (1 + 0)); H34++) {
		for (int H43 = 0; H43 < 1; H43++) {
			...
			tmp29 = tmp30 + tmp33;
			output[(((1 + ((m - (1 + 0)) - (1))) + (m - (m - (1))))) * ((H34 - (1))) + H43 + 1 * ((1 + ((m - (1 + 0)) - (1))) + (m - (m - (1)))) * 1] = tmp18 + tmp29;
		}
		for (int H44 = 1; H44 < (m - (1 + 0)); H44++) {
			...
			tmp45 = tmp46 + tmp49;
			output[(((1 + ((m - (1 + 0)) - (1))) + (m - (m - (1))))) * ((H34 - (1))) + (H44 - (1)) + 1 * 1 + 1 * ((1 + ((m - (1 + 0)) - (1))) + (m - (m - (1)))) * 1] = tmp34 + tmp45;
		}
		for (int H45 = m - (1); H45 < m; H45++) {
			...
			output[(((1 + ((m - (1 + 0)) - (1))) + (m - (m - (1))))) * ((H34 - (1))) + (H45 - (m - (1))) + (1 + ((m - (1 + 0)) - (1))) * 1 + 1 * ((1 + ((m - (1 + 0)) - (1))) + (m - (m - (1)))) * 1] = tmp50 + tmp65;
		}
	}
	for (int H46 = n - (1); H46 < n; H46++) {
		for (int H47 = 0; H47 < m; H47++) {
			...
			output[(m) * ((H46 - (n - (1)))) + H47 + (1 + ((n - (1 + 0)) - (1))) * m * 1] = tmp66 + tmp77;
		}
	}
}
