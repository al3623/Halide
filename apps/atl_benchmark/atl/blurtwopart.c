...
void blurtwopart(float* v,int M,int N,float*output){
	...
	for (int H37 = 1; H37 < (N + 1 + 0); H37++) {
		for (int H46 = 0; H46 < 1; H46++) {
			...
			tmp2[(((1 + ((M - (1 + 0)) - (1))) + (M - (M - (1))))) * ((H37 - (1))) + H46 + 1 * ((1 + ((M - (1 + 0)) - (1))) + (M - (M - (1)))) * 1] = tmp3 + tmp4;
		}
		for (int H47 = 1; H47 < (M - (1 + 0)); H47++) {
			...
			tmp2[(((1 + ((M - (1 + 0)) - (1))) + (M - (M - (1))))) * ((H37 - (1))) + (H47 - (1)) + 1 * 1 + 1 * ((1 + ((M - (1 + 0)) - (1))) + (M - (M - (1)))) * 1] = tmp5 + tmp8;
		}
		for (int H48 = M - (1); H48 < M; H48++) {
			...
			float tmp10 = 0;
			tmp10 = v[(((M)) * (H37 - (1))) + H48];
			tmp2[(((1 + ((M - (1 + 0)) - (1))) + (M - (M - (1))))) * ((H37 - (1))) + (H48 - (M - (1))) + (1 + ((M - (1 + 0)) - (1))) * 1 + 1 * ((1 + ((M - (1 + 0)) - (1))) + (M - (M - (1)))) * 1] = tmp9 + tmp10;
		}
	}
	for (int H49 = N + 1; H49 < N + 2; H49++) {
		for (int H50 = 0; H50 < M; H50++) {
			tmp2[(M) * ((H49 - (N + 1))) + H50 + (1 + ((N + 1 + 0) - (1))) * M * 1] = 0;
		}
	}
	float* x0 = tmp2;
